<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cremas.aspx.cs" Inherits="WebApplication1.Materiales.cremas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ListView ID="lsvDatos" runat="server" DataSourceID="lqDatos" 
        DataKeyNames="idcrema" GroupItemCount="3" 
        ...
        <td id="Td1" runat="server" style="">
            ...
            <br />
            <asp:Image ID="imagenTextBox" class="imgItem" runat="server" ImageUrl='<%# string.Format("~/Materiales/cremas/{0}",Eval("imagen")) %>' />
            <br /> 
        ...
        <EmptyDataTemplate>
            ...
            <asp:Button ID="btnAgregar" runat="server" CssClass="boton_1" Text="Agregar Nueva Crema" CommandName="AgregarCrema" />
        </EmptyDataTemplate>
        <EmptyItemTemplate>
        ...
        <InsertItemTemplate>
            <td id="Td3" runat="server" style="">
                <div class="divInsert" >
                Nombre:
               <asp:TextBox ID="nombreTextBox" runat="server" Text='<%# Bind("nombre") %>' /><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="nombreTextBox"></asp:RequiredFieldValidator>
                <br />Imagen:
                <asp:FileUpload ID="imgFile" runat="server" /><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="imgFile"></asp:RequiredFieldValidator>
                <br />Precio:
                <asp:TextBox ID="precioTextBox" runat="server" Text='<%# Bind("precio") %>' /><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="precioTextBox"></asp:RequiredFieldValidator>
        ...
        <ItemTemplate>
            ...
            <div class="divItemLSV">
                ...
                <%--Código:
                <asp:Label ID="idbaseLabel" runat="server" Text='<%# Eval("idcrema") %>' />
                <br />--%>&nbsp;<br /><asp:Label ID="nombreLabel"  Width="200px" runat="server" Text='<%# Eval("nombre") %>' />
                <br />
                <asp:Image ID="imagenLabel" class="imgItem" runat="server" ImageUrl='<%# string.Format("~/Materiales/cremas/{0}",Eval("imagen")) %>' />
                <br />Precio: $ 
        ...
        <SelectedItemTemplate>
            <td id="Td7" runat="server" style="">
                ...
                <br />Imagen:<br />
                <asp:Image ID="imagenLabel" ImageAlign="Middle" runat="server" Width="180" Height="150" ImageUrl='<%#string.Format("~/Materiales/cremas/{0}",Eval("imagen")) %>' />
                <br />Precio:
                <asp:Label ID="precioLabel" runat="server" Text='<%# Eval("precio") %>' />
                <br />
                <asp:Button ID="EditButton" runat="server" CommandName="Edit" Text="Editar" />
    ...
    <asp:LinqDataSource ID="lqDatos" runat="server" 
        ...
        EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="cremas">
    </asp:LinqDataSource>
