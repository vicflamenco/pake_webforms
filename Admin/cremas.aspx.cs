...
{
    public partial class cremas : System.Web.UI.Page
    {
        ...
        protected void lsvDatos_ItemInserting(object sender, ListViewInsertEventArgs e)
        {
            ...
            {
                imgFile.SaveAs(Server.MapPath("~/Materiales/cremas/" + imgFile.FileName));
        ...
        protected void lsvDatos_ItemUpdating(object sender, ListViewUpdateEventArgs e)
        {
            ...
            if (e.NewValues["imagen"] != e.OldValues["imagen"])
            {
                try
                {
                    System.IO.File.Delete(Server.MapPath("~/Materiales/cremas/" + System.IO.Path.GetFileName(foto.ImageUrl)));
                }
                catch
                { }

                img.SaveAs(Server.MapPath("~/Materiales/cremas/" + img.FileName));
            }
        }
