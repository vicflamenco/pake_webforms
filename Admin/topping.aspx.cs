...
namespace WebApplication1.Materiales
{
    public partial class topping : System.Web.UI.Page
    {
        ...
        protected void lsvDatos_ItemInserting(object sender, ListViewInsertEventArgs e)
        {
            ...
            {
                imgFile.SaveAs(Server.MapPath("~/Materiales/topping/" + imgFile.FileName));
        ...
        {
            if (e.CommandName == "AgregarTopping")
            {
        ...
        protected void lsvDatos_ItemUpdating(object sender, ListViewUpdateEventArgs e)
        {
            ...
            if (e.NewValues["imagen"] != e.OldValues["imagen"])
            {
                try
                {
                    System.IO.File.Delete(Server.MapPath("~/Materiales/topping/" + System.IO.Path.GetFileName(foto.ImageUrl)));
                }
                catch
                { }

                img.SaveAs(Server.MapPath("~/Materiales/topping/" + img.FileName));
            }
        }
        ...
        protected void lsvDatos_ItemDeleting(object sender, ListViewDeleteEventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    System.IO.File.Delete(Server.MapPath("~/Materiales/topping/" + System.IO.Path.GetFileName(img.ImageUrl)));
                }
                catch { }
            }
        }
