...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        ...
        <asp:LinkButton ID="RegisterHyperLink1" PostBackUrl="~/Account/Register.aspx" runat="server" EnableViewState="false">Registrarse</asp:LinkButton> 
    </p>
        ...
        <LayoutTemplate>--%>
            ...
            <div class="accountInfo">
                ...
                <p class="submitButton">
                    <asp:Button ID="LoginButton" runat="server" Text="Iniciar sesión" ValidationGroup="LoginUserValidationGroup" OnClick="LoginButton_Click"/>
                </p>
            </div>
<%--        </LayoutTemplate>
    </asp:Login>--%>
